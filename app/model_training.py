...
from model_utils import getTarget, getIndex, get_age, get_customer_seniority, get_income
...
def processData(in_file_name, cust_dict):
    ...
    for row in csv.DictReader(in_file_name):
        ...
        x_vars.append(get_customer_seniority(row))
        x_vars.append(get_income(row))
...
def big_run_main():
    ...
    print("opening training file", end="")
    ...
    print("closing train file", end="")
    train_file.close()
    print("done")
    print(train_X.shape, train_y.shape)
    print(datetime.datetime.now() - start_time)
    print("Opening test file...", end="")
    ...
    if cont == "Y":
        ...
        model.save_model('genify001.model')
        print("done.")
...
if __name__ == "__main__":
    print("'ello guvnah")
    file_path = input("small file path: ")
    small_file = open(file_path)
    for row in csv.DictReader(small_file):
        print(row)
