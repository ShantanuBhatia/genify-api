...
mapping_dict = {
    ...
    'tiprel_1mes': {-99: 0, 'INACTIVE': 1, 'ACTIVE': 2, 'FORMER': 3, 'POTENTIAL': 4, 'N': 5},
    'indresi': {-99: 0, 'S': 1, 'N': 2},
    'indext': {-99: 0, 'S': 1, 'N': 2},
    'conyuemp': {-99: 0, 'S': 1, 'N': 2},
    'indfall': {-99: 0, 'S': 1, 'N': 2},
    'tipodom': {-99: 0, '1': 1},
    'ind_actividad_cliente': {'INACTIVE': 0, 'ACTIVE': 1, -99: 2},
    'segmento': {'INDIVIDUAL': 0, 'STUDENT': 1, 'VIP': 2, -99: 2},
...
eng_to_esp_inputs = {
    "cust_id": "ncodpers",
    "nationality": "pais_residencia",
    "gender": "sexo",
    "age": "age",
    "seniority": "antiguedad",
    "rel_type": "tiprel_1mes",
    "activity_type": "ind_actividad_cliente",
    "income": "renta",
    "segment": "segmento"
}

missing_cols = ["fecha_dato", "ind_empleado", "fecha_alta", "ind_nuevo", "indrel", "ult_fec_cli_1t", "indrel_1mes",
